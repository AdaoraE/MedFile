...
function Hero() {
  return (
    <section className='flex flex-col justify-center items-center mt-[4.5rem]  text-center'>
      <h1 className='capitalize w-[61rem] text-7xl font-semibold'>digital transformation made easy with <span className='text-main-color'>medfile</span></h1>
      <p className='font-normal text-2xl w-[70rem] leading-7 pt-6 pb-10'>Introducing a new classification system that enhances clinical documentation and provides more efficient management of patient information </p>
      <div>
