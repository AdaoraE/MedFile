...
function Hero() {
  return (
    <section name='Product' className='flex flex-col items-center   '>
      ...
      <h1 className='capitalize text-3xl md:text-7xl font-semibold mt-24 text-center'>digital transformation made <br/>easy with <span className='text-main-color'>medfile</span></h1>
      <p className='font-normal text-lg md:text-3xl leading-7 pt-6 pb-10'>Introducing a new classification system that enhances clinical documentation and provides more efficient management of patient information </p>
      ...
      <div className='border-2 mt-20 border-main-color'> 
